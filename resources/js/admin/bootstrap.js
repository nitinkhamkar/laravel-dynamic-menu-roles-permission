...
try {
    ...
    require('adminbsb-materialdesign/plugins/multi-select/js/jquery.multi-select.js');
    require('adminbsb-materialdesign/plugins/jquery-slimscroll/jquery.slimscroll.js');
    global.Waves= require('adminbsb-materialdesign/plugins/node-waves/waves.js');
    require('adminbsb-materialdesign/plugins/jquery-countto/jquery.countTo.js');
    global.Raphael= require('adminbsb-materialdesign/plugins/raphael/raphael.min.js');
    ...
    require('adminbsb-materialdesign/plugins/jquery-validation/jquery.validate');
